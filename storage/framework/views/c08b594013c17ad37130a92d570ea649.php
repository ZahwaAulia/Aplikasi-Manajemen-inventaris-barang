                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <p><strong>Tanggal Pembelian:</strong>
                                            <?php echo e($item->purchase_date ? \Carbon\Carbon::parse($item->purchase_date)->format('d/m/Y') : 'N/A'); ?>

                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Tanggal Kadaluarsa Garansi:</strong>
                                            <?php echo e($item->warranty_expiry ? \Carbon\Carbon::parse($item->warranty_expiry)->format('d/m/Y') : 'N/A'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/admin/items/show.blade.php ENDPATH**/ ?>