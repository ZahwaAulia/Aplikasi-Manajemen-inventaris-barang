                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder"><?php echo e($totalItems ?? 0); ?></h5>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder"><?php echo e($totalCategories ?? 0); ?></h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder"><?php echo e($totalSuppliers ?? 0); ?></h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder"><?php echo e($availableItems ?? 0); ?></h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-6">
                            <div class="text-center">
                                <h4 class="font-weight-bolder text-success"><?php echo e($availableItems ?? 0); ?></h4>
                                <p class="text-sm mb-0">Tersedia</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center">
                                <h4 class="font-weight-bolder text-warning"><?php echo e($borrowedItems ?? 0); ?></h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                <h4 class="font-weight-bolder text-danger"><?php echo e($damagedItems ?? 0); ?></h4>
                ...
                <div class="card-body p-3">
                    <ul class="list-group">
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            ...
                            <div class="d-flex">
                                <a href="<?php echo e(route('admin.items.index')); ?>" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            ...
                            <div class="d-flex">
                                <a href="<?php echo e(route('admin.categories.index')); ?>" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                                    <i class="ni ni-bold-right" aria-hidden="true"></i>
                                </a>
                            </div>
                        </li>
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                            ...
                            <div class="d-flex">
                                <a href="<?php echo e(route('admin.suppliers.index')); ?>" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto">
                                    <i class="ni ni-bold-right" aria-hidden="true"></i>
                                </a>
                            </div>
                        </li>
