                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <li class="nav-item d-flex align-items-center">
                                <span class="nav-link text-body font-weight-bold px-0">
                                    ...
                                    <span class="d-sm-inline d-none">Welcome, <?php echo e(Auth::user()->name); ?></span>
                                </span>
                            </li>
                            <li class="nav-item d-flex align-items-center">
...
<?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/layouts/app.blade.php ENDPATH**/ ?>