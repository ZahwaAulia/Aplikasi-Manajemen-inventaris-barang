                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.suppliers.show', $supplier)); ?>"
                                                    class="btn btn-sm btn-info" title="Lihat Detail">
                                                    <i class="fas fa-eye"></i> Lihat
                                                </a>
                                                <a href="<?php echo e(route('admin.suppliers.edit', $supplier)); ?>"
                                                    class="btn btn-sm btn-warning" title="Edit Supplier">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <?php if($supplier->status === 'pending'): ?>
                                                    <form action="<?php echo e(route('admin.suppliers.approve', $supplier)); ?>"
                                                    ...
                                                    <form action="<?php echo e(route('admin.suppliers.reject', $supplier)); ?>"
                                                        method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" class="btn btn-sm btn-danger"
                                                            title="Tolak Supplier"
                                                            onclick="return confirm('Apakah Anda yakin ingin menolak supplier ini?')">
                                                            <i class="fas fa-times"></i> Tolak
                                                        </button>
                                                    </form>
                                                <?php endif; ?>
                                                <form action="<?php echo e(route('admin.suppliers.destroy', $supplier)); ?>"
                                                    method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>