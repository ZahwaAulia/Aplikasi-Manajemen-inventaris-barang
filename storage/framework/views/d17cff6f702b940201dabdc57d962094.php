...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
        <div class="sidenav-header">
            ...
            box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.1) !important;
                ...
                <img src="<?php echo e(asset('assetadmin/img/logo-ct.png')); ?>" class="navbar-brand-img h-100" alt="main_logo">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="<?php echo e(asset('assetadmin/img/team-2.jpg')); ?>" class="avatar avatar-sm me-3">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="<?php echo e(asset('assetadmin/img/small-logos/logo-spotify.svg')); ?>" class="avatar avatar-sm bg-gradient-dark me-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal mb-1">
    ...
    <script src="<?php echo e(asset('assetadmin/js/argon-dashboard.js')); ?>"></script>
</body>
</html>

<?php /**PATH C:\Users\user\Documents\GitHub\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/layouts/app.blade.php ENDPATH**/ ?>