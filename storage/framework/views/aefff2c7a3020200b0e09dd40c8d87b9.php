...
<body>
        ...
        <div class="container">
            <div class="hero-card text-center">
                ...
                <div class="hero-stats mb-4">
                    <div class="hero-stat">
                        <h3><?php echo e($stats['total_items']); ?></h3>
                        <span>Barang</span>
                    </div>
                    <div class="hero-stat">
                    ...
                    <div class="hero-stat">
                        <h3><?php echo e($stats['total_suppliers']); ?></h3>
                        <span>Supplier</span>
                    </div>
                </div>

                <a href="<?php echo e(route('login')); ?>" class="btn-main">
    ...
    <!-- ITEMS -->
    <?php if($stats['recent_items']->count() > 0): ?>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn-main">Login Sekarang</a>
        </div>
    </section>
...
<?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/welcome.blade.php ENDPATH**/ ?>