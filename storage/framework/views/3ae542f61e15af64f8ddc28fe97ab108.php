                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3">
                            <?php if(Auth::user()->profile_photo): ?>
                                <img src="<?php echo e(asset(Auth::user()->profile_photo)); ?>" alt="Profile Photo" class="rounded-circle"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <a href="<?php echo e(route('guest.items.index', ['status' => 'tersedia'])); ?>"
                                    ...
                                    <div class="card bg-primary text-white h-100 dashboard-card">
                                        <div class="card-body text-center">
                                            ...
                                            <h5><?php echo e($totalAvailableItems); ?> Barang Tersedia</h5>
                            ...
                            <!-- KATEGORI -->
                            <div class="col-md-4">
                                <a href="<?php echo e(route('guest.categories.index')); ?>" class="text-decoration-none">
                        ...
                        <div class="row">
                            <?php $__empty_1 = true; $__currentLoopData = $availableItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-md-4 mb-4">
                                    <a href="<?php echo e(route('guest.items.show', $item)); ?>" class="text-decoration-none">
                                        <div class="card h-100 dashboard-card">
                                            <div class="card-body">
                                                <?php if($item->image): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/guest/dashboard.blade.php ENDPATH**/ ?>