    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('staff.items.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="stock_quantity" name="stock_quantity" value="<?php echo e(old('stock_quantity')); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" id="unit_price" name="unit_price" value="<?php echo e(old('unit_price')); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                        ...
                                        <option value="dikeluarkan" <?php echo e(old('status') == 'dikeluarkan' ? 'selected' : ''); ?>>Dikeluarkan</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="purchase_date" name="purchase_date" value="<?php echo e(old('purchase_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="warranty_expiry" name="warranty_expiry" value="<?php echo e(old('warranty_expiry')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views\staff\items\create.blade.php ENDPATH**/ ?>