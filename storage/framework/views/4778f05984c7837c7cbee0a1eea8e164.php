                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    <?php if($user->profile_photo): ?>
                                        <img src="<?php echo e(asset($user->profile_photo)); ?>" alt="Profile Photo"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/profile/edit.blade.php ENDPATH**/ ?>