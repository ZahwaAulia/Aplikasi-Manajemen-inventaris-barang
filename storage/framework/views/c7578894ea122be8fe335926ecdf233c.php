            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="<?php echo e(route('supplier.items.index')); ?>" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="<?php echo e(route('supplier.items.index')); ?>" class="btn btn-outline-secondary">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?php echo e($item->status == 'tersedia' ? 'success' : ($item->status == 'dipinjam' ? 'warning' : 'secondary')); ?>">
                                                    <?php echo e(ucfirst($item->status)); ?>

                                                </span>
                                            </td>
                                            <td class="d-flex gap-1">
                                                <a href="<?php echo e(route('supplier.items.show', $item)); ?>"
                                                    class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye me-1"></i> Detail
                                                </a>
                                                <a href="<?php echo e(route('supplier.items.edit', $item)); ?>"
                                                    class="btn btn-sm btn-warning">
                                                    <i class="fas fa-edit me-1"></i> Edit
                                                </a>
                                                <form action="<?php echo e(route('supplier.items.destroy', $item)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon-6.0-minimal\www\Aplikasi-Manajemen-inventaris-barang\Aplikasi-Manajemen-inventaris-barang\resources\views/supplier/items/index.blade.php ENDPATH**/ ?>