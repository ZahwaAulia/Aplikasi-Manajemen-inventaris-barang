          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Barang Stok Rendah</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{ $lowStockItems ?? 0 }}
                    </h5>
                  </div>
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Barang baru ditambahkan</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">2 hari yang lalu</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Stok barang diperbarui</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">4 hari yang lalu</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Kategori baru dibuat</h6>
                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">1 minggu yang lalu</p>
                  </div>
                </div>
              </div>
            </div>
