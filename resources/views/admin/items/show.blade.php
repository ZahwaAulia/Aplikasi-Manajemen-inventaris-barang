                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Status:</strong>
                                            <span
                                                class="badge bg-{{ $item->status == 'tersedia' ? 'success' : ($item->status == 'dipinjam' ? 'warning' : 'secondary') }}">
                                                {{ ucfirst($item->status) }}
                                            </span>
                                        </p>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <p><strong>Tanggal Kadaluarsa Garansi:</strong>
                                            {{ $item->warranty_expiry ? \Carbon\Carbon::parse($item->warranty_expiry)->format('d/m/Y') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                                <div class="mt-3">
