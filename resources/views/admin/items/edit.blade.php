                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('stock_quantity', $item->stock_quantity) }}" min="0"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('unit_price') is-invalid @enderror"
                                            ...
                                            value="{{ old('unit_price', $item->unit_price) }}" min="0"
                                            step="0.01">
                                        @error('unit_price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('condition') is-invalid @enderror" id="condition"
                                            ...
                                            <option value="baik"
                                                {{ old('condition', $item->condition) == 'baik' ? 'selected' : '' }}>Baik
                                            </option>
                                            <option value="rusak"
                                                {{ old('condition', $item->condition) == 'rusak' ? 'selected' : '' }}>Rusak
                                            </option>
                                            <option value="perlu_perbaikan"
                                                {{ old('condition', $item->condition) == 'perlu_perbaikan' ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="tersedia"
                                                {{ old('status', $item->status) == 'tersedia' ? 'selected' : '' }}>Tersedia
                                            </option>
                                            <option value="dipinjam"
                                                {{ old('status', $item->status) == 'dipinjam' ? 'selected' : '' }}>Dipinjam
                                            </option>
                                            <option value="dikeluarkan"
                                                {{ old('status', $item->status) == 'dikeluarkan' ? 'selected' : '' }}>
                                                Dikeluarkan</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('warranty_expiry', $item->warranty_expiry ? $item->warranty_expiry->format('Y-m-d') : '') }}">
