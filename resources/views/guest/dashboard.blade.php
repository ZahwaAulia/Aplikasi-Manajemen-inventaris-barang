                    ...
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3">
                            @if (Auth::user()->profile_photo)
                                <img src="{{ asset(Auth::user()->profile_photo) }}" alt="Profile Photo" class="rounded-circle"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <!-- KATEGORI -->
                            <div class="col-md-4">
                                <a href="{{ route('guest.categories.index') }}" class="text-decoration-none">
                        ...
                        <div class="row">
                            @forelse($availableItems as $item)
                                <div class="col-md-4 mb-4">
                                    <a href="{{ route('guest.items.show', $item) }}" class="text-decoration-none">
                                        <div class="card h-100 dashboard-card">
                                            <div class="card-body">
                                                @if ($item->image)
